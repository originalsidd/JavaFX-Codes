// JavaFX Event Handling - setOnAction and such
...
public class javaFx3 extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		b3.setOnAction(new EventHandler<ActionEvent>() {
			public void handle(ActionEvent ae) {
				System.out.println("This won't be processed");
				lb.setText("Nothing!");
			}
		});
		...
		// Only last listener will be considered for multiple same type of listener on single source object 
